...
## 🛠️ The Team Workflow (Follow these exact steps)
...
4. As a team, divide up the 4 issues in `ISSUES.md`. *(Hint: Make sure different team members take on Issue #1 and Issue #2!)*
...
13. **Important:** Do NOT merge this final PR yourselves — I will review all teams' final PRs after the activity. Just make sure it's open and clearly labeled!
